      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _context.t0 = (0, _ignore2.default)();
            _context.t1 = _ignored2.default + '\n';
          ...
          case 15:
            _context.t2 = npmIgnore;

          case 16:
            _context.t3 = _context.t2;
            _context.t4 = clearRelative(_context.t3);
            _context.t5 = _context.t1 + _context.t4;
            filter = _context.t0.add.call(_context.t0, _context.t5).createFilter();
...
var asAbsolute = function asAbsolute(path, parent) {
  ...
  var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6(paths, _ref6) {
    var _this = this;

    var accepts = _ref6.accepts;
    var list, many;
    return _regenerator2.default.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            list = function () {
              var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(file) {
                var path, s, all;
                return _regenerator2.default.wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 25:
                        all = _context3.sent;
                        return _context3.abrupt('return', many(all.map(function (subdir) {
                ...
                }, _callee3, _this, [[4, 10], [13, 19]]);
              }));

              return function list(_x10) {
                return _ref7.apply(this, arguments);
              };
            }();

            many = function () {
              var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(all) {
                    ...
                    switch (_context5.prev = _context5.next) {
                      case 0:
                        ...
                        return _promise2.default.all(all.map(function () {
                          var _ref9 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(file) {
          ...
          case 4:
            ...
            _context6.t1 = function (v) {
              return v !== null;
            };

            return _context6.abrupt('return', (0, _arrFlatten2.default)(_context6.t0).filter(_context6.t1));
  ...
  return function explode(_x8, _x9) {
...
var maybeRead = function () {
  var _ref10 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(path) {
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 6:
            ...
            return _context7.abrupt('return', default_);
  ...
  return function maybeRead(_x13, _x14) {
