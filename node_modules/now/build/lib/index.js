  ...
  (0, _createClass3.default)(Now, [{
    ...
    value: function getNameservers(domain) {
      ...
      return new _promise2.default(function (resolve) {
        ...
        _this7.retry(function () {
          var _ref17 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(bail, attempt) {
            var res, body;
    ...
    value: function setupDomain(name) {
      ...
      var _ref18 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          isExternal = _ref18.isExternal;

      return this.retry(function () {
        var _ref19 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12(bail, attempt) {
    ...
    value: function createCert(domain) {
      ...
      return this.retry(function () {
        var _ref21 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(bail, attempt) {
            ...
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  ...
                  _context13.next = 3;
                  return _this9._fetch('/now/certs', {
                    method: 'POST',
                    body: {
                      domains: [domain],
                      renew: renew
                ...
                case 19:
                  ...
                  _err.userError = true;
                  // dont retry
                  return _context13.abrupt('return', bail(_err));
    ...
    value: function deleteCert(domain) {
      ...
      return this.retry(function () {
        var _ref22 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee14(bail, attempt) {
          var res, err;
            ...
            while (1) {
              switch (_context14.prev = _context14.next) {
                case 0:
                  ...
                  _context14.next = 3;
                  return _this10._fetch('/now/certs/' + domain, {
                    method: 'DELETE'
                  });
    ...
    key: 'remove',
    value: function () {
      var _ref23 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee16(deploymentId, _ref24) {
        var _this11 = this;

        var hard = _ref24.hard;
        var data;
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                ...
                _context16.next = 3;
                return this.retry(function () {
                  var _ref25 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee15(bail) {
                    var res;
                      ...
                      while (1) {
                        switch (_context15.prev = _context15.next) {
                          case 0:
                            ...
                            _context15.next = 3;
                            return _this11._fetch('/now/remove', {
                              method: 'DELETE',
                              body: data
                            });
                          ...
                          case 3:
                            ...
                            return _context15.abrupt('return', bail(responseError(res)));
    ...
    value: function retry(fn) {
      var _ref26 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          _ref26$retries = _ref26.retries,
          retries = _ref26$retries === undefined ? 3 : _ref26$retries,
          _ref26$maxTimeout = _ref26.maxTimeout,
          maxTimeout = _ref26$maxTimeout === undefined ? Infinity : _ref26$maxTimeout;
    ...
    get: function get() {
      ...
      if (!this._syncAmount) {
        this._syncAmount = this._missing.map(function (sha) {
          return _this12._files.get(sha).data.length;
        }).reduce(function (a, b) {
          return a + b;
        }, 0);
      }
